...
대통령의 특별한 권한으로 사면권이 존재하는데 이에 대한 남용에 대한 우려가 꾸준히 제기되어 왔고 이를 제한하는 방법에 대한 다양한 주장을 갑, 병, 정이 하고 있다. 갑의 주장에 따르면 일반 사면, 특별 사면을 특별히 구분하지 않고 모두 의회의 승인을 받아 정해진 공론하는 차원에서만 사면권을 허용해야 한다고 한다. 그리고 을의 주장에 따르면 둘은 역시 일반 사면, 특별 사면을 구분하지 않는데 단지 법의 통제 하에서 사면에 대한 자문을 대통령에게 인정해야 한다고 한다. 병과 사면에 대해서는 특별한 제한을 제시하지 않고 있지만 정치이나 측근에 대한 특별 사면은 정당화될 수 없다고 한다. 병의 경우에는 일반 사면과 특별 사면을 구분하여 전자에 대해서는 제한을 할 필요가 없지만 후자에 대해서는 헌법 질서 파괴 그런 범위에 한 지나 죄를수가 철저하게 경우에 한해서만 특별 사면을 허용해야 한다. 단 범죄가 일단 적용 받을 수 있는 죄를수가 상당해 진 경우에 특별한 자문을 받아야 하는 기본적으로 내용적인 측면에서 제한을 인정하지는 않고 있다. 다만 모든 종류의 사면에 있어 관련 심의 기관의 심의와 국회의 동의를 모두 받아야 사면이 정당화된다고 한다.

사례 (가)는 헌정 질서를 교란한 것이지만 대통령과 정치적으로 대립하는 정치인 이당 대표 A에 대한 특별 사면에 관한 내용이다. 절차적으로는 관련 심의 기관의 심의와 국회의 동의를 모두 받아 진행되었다. 따라서 정치에 대한 사면이므로 갑이 의회서 정당화되며 심의와 동의를 모두 거쳤으므로 정의 의해서도 정당화되는 사안일 것이다. 다만 정치에 대한 특별 사면이므로 을의 의해서는 정당화되지 않고 헌정 질서 교란 자에 대한 특별 사면으로 병에 의해서도 정당성을 인정받을 수 없다. 따라서 사안 (가)의 정당성을 인정하는 주장은 갑과 정의이다.

사례 (나)는 대통령의 차기를 공고히 대한 특별 사면이며 절차에 있어서 관련 심의 기관의 심의와 국회의 동의를 받지 않은 채 진행되었다. 정치에 대한 사면이 아니므로 병의 의해서는 정당화되지만, 의회서 정한 법률 절차에 따르지 않고 심의와 국회의 동의를 받지 않았으므로 갑, 을, 정의 의해서 정당화되지 않는다. 그리고 헌정 질서 파괴나 뇌물수수와 법치를 저지른 것이 아니므로 병에 의해서도 정당화되지만 국회의 동의를 받지 않았으므로 정에 의해서는 정당화될 수 없다. 따라서 사안 (나)의 정당성을 인정하는 주장은 병이다.

사례 (다)는 경기 활성화 차원에서 진행된 일반 사면으로 관련 심의 기관의 심의와 국회의 동의를 거치지 않은 경우이다. 정치인이 아니고 경제활동을 앞둔 사람으로 정적인 때문의 사면이나 사회약자에 대한 경우와 직결되지 않았지만, 일반 사면이므로 을과 병의 의해서는 정당화되고, 심의와 동의 절차를 거쳤으므로 정의 의해서 정당화된다. 따라서 사례 (다)의 정당성을 인정하는 주장은 을, 병, 정이다.

(가)에서의 대통령의 사면권 행사는 갑, 정의 의해서만 정당성을 인정받고, (나)에서의 대통령의 사면권 행사는 병에 의해서만 정당성을 인정받으며, (다)에서의 대통령의 사면권 행사는 을, 병, 정의 의해서만 정당성을 인정받는다. 따라서 정답은 (5)이다.
...
* 평가 목표 : 특정한 법규정의 요건들에 관련해 법규정을 정확하게 이해하여 각 사례에 바르게 적용할 수 있는지를 측정함

### 제시문 해설

* 정답 : (2)

A법이 적용되는 사업장에 대한 규정을 제시한 후 몇 가지 사례에 A법이 적용되는지 묻는 문제이다. A법은 상시 사용하는 근로자 수가 5명 이상인 사업장에 적용되는데 상시 사용하는 근로자 수는 만인의 산정 기간 동안의 총 연인원을 가동일수에서 사용하는 근로자수로 계산한다. 다만 근로자 수가 5명 이상이라는 가정상 일별로 근로자 수를 파악한 결과 법률이 미달되는 사업자에 가해 가동일수의 과반이 1 이상이면 A법은 적용된다. 또한 산정기간에 포함하는 사람이 정해져 있었으며 1호의 민법상 재난 및 기준으로 저는 재외되지 않는다고 그러지는 보아야 한다.

### <보기> 해설

ㄱ. 민인의 처음 10일 동안, 1일에 5명, 나머지 9일간은 20명씩 사용하였으므로 (10일×5명+9일×20명=230명), 가동일수는 20일이므로 총상시 근로자 수는 5명이다. (가)의 조건을 충족하였으므로 A법이 적용되는 사업체이다. 하지만 설립 당일부터 1월 동안 사용한 근로자를 특정하여 보면 사업자가 기간 중 휴직자에 한 적은 기간이 5명 미만인 일수가 10일이고 이는 전체 가동일수 20일의 과반인 10일이므로 A법은 적용되지 않는다. ㄱ은 옳지 않은 추론이다.

ㄴ. 가동일수 1개월간 매일 5명의 단시간 근로자가 사용되었다. (라)에 따라 단시간 근로자는 만인의 산정 시 포함된다. 결국 상시 사용하는 근로자 수는 (5명×1개월/1개월)=5명이고, (가)는 해당하지 않으므로 A법은 적용된다. ㄴ은 옳은 추론이다.

ㄷ. 사업에서 고정적으로 매일 근무한 근로자는 총 7명이다. 하지만 만인의 산정 시 산재자인 근로자가 1인 도움 받을 근로자 수에서 제외되고, 임원 중 고용계약을 체결하고, 결과 상시 사용하는 근로자 수는 (5명×1개월/1개월)=5명이다. 그리고 이 사업장은 친족과 단시간 근로자로 구성되어 결국 친족만을 사용하는 사업장이 아니므로 (기)의 적용배제 규정은 적용되지 않는다. 또한 (다)도 해당 사항 없으므로 사업에는 A법이 적용된다. ㄷ은 옳지 않은 추론이다.
...
* 평가 목표 : 고대 로마의 켄투리아 회의 제도 개편 전후의 투표수와 투표 순서를 이해하여, 투표가 어느 등급에서 종료될 수 있는지를 추론할 수 있는지 측정함

### 제시문 해설

* 정답 : (4)

제시문에 따르면 개편 이전의 켄투리아 회의 총 투표수는 193표이며, 개편 이후에는 제시된 두 가지 가정이 가능하다. 각 경우의 투표수와 투표 순서를 바탕으로, 특정 등급의 의견이 일치한 경우 이후 등급이 투표할 수 있었는지 여부를 판단하는 문항이다.
...
(3) F-조건은 연구 결과가 최초의 것이어야 한다는 조건이고, I-조건은 연구 결과가 독립적으로 성취한 것이어야 한다는 조건이다. 타르탈리아는 독자적으로 3차 방정식의 일반 해법을 최초로 발견하였으므로, F-조건과 I-조건을 모두 적용했을 때 우선권을 가진다. 뉴턴은 미적분법을 누구보다 먼저 연구해서 라이프니츠가 1675년부터 독자적으로 연구를 수행하기 전에 이미 전체 내용을 완성했다. 그러므로 F-조건과 I-조건을 모두 적용했을 때 우선권을 지닌다. 이는 옳은 추론이다.
